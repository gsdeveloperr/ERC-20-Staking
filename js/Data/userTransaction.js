...
const userProfileHTML = `
  <div class="contract-user-profile">
    ...
    <div class="contract-user-profile-info">
      <p><strong>Address: ${User.address.slice(0, 25)}</strong></p>

      <span class="contract-space">
        <p><strong>Stake Amount:&nbsp;</strong>${
          User.stakeAmount / 10 ** 18
        }</span></p>

      <span class="contract-space">
        <strong>Last Reward Calculation Time:&nbsp;</strong>${generateCountDown(
          User.lastRewardCalculationTime
        )}</span>

      <span class="contract-space">
        <strong>Last Stake Time:&nbsp;</strong>${generateCountDown(
          User.lastStakeTime
        )}</span>
      ...
      <span class="contract-space">
        <strong>Rewards Claimed So Far:&nbsp;</strong>${
          User.rewardsClaimedSoFar / 10 ** 18
        }</span>

      <p class="contract-paragraph">
        here you can check your recent transaction.
      </p>
    </div>
  </div>
`;
